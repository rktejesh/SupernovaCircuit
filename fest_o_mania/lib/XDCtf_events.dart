...
class XDCtf_events extends StatelessWidget {
  XDCtf_events({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'searchIcon_ctf' (group)
                PageLink(
              links: [
                PageLinkInfo(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    pinBottom: true,
                    child:
                        // Adobe XD layer: 'mygov46562_15125410…' (shape)
                        Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(25.0),
                        image: DecorationImage(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'backarrow_ctf' (group)
                PageLink(
              links: [
                PageLinkInfo(
