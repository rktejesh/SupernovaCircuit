...
class XDMain_page_upcoming extends StatelessWidget {
  XDMain_page_upcoming({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: '3line_mainpgupcom' (group)
                SizedBox(
              width: 61.0,
              height: 52.0,
              child: Stack(
          ...
          Transform.translate(
            offset: Offset(180.0, 409.0),
            child:
                // Adobe XD layer: 'liveIcon_mainpgupcom' (group)
                PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 53.0, 53.0),
                      size: Size(53.0, 53.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(4.4, 10.9, 44.0, 31.1),
                      size: Size(53.0, 53.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
          ...
          Transform.translate(
            offset: Offset(277.0, 395.0),
            child:
                // Adobe XD layer: 'upcomingIc_mainpgup…' (group)
                SizedBox(
              width: 89.0,
              height: 81.0,
              child: Stack(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'box1_mainpgupcom' (group)
                SizedBox(
              width: 368.0,
              height: 210.0,
              child: Stack(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'box2_mainpgupcom' (group)
                SizedBox(
              width: 368.0,
              height: 210.0,
              child: Stack(
...
const String _svg_z7ypdp =
    '<svg viewBox="342.0 14.0 52.0 52.0" ><path transform="translate(342.0, 14.0)" d="M 0 0 L 52 0 L 52 52 L 0 52 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
