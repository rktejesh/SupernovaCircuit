      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: '3line_mainpgbookmark' (group)
                SizedBox(
              width: 61.0,
              height: 52.0,
              child: Stack(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(21.0, 17.0, 46.0, 46.0),
                    size: Size(89.0, 81.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(33.4, 23.5, 21.3, 33.0),
                    size: Size(89.0, 81.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: SvgPicture.string(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'liveIcon_mainpagebo…' (group)
                PageLink(
              links: [
                PageLinkInfo(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'box1_mainpgbookmark' (group)
                SizedBox(
              width: 368.0,
              height: 210.0,
              child: Stack(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'box2_mainpgbookmark' (group)
                SizedBox(
              width: 368.0,
              height: 210.0,
              child: Stack(
