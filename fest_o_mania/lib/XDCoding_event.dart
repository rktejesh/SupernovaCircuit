...
class XDCoding_event extends StatelessWidget {
  XDCoding_event({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'searchIcon_codingevn' (group)
                PageLink(
              links: [
                PageLinkInfo(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'box3_codingevn' (group)
                SizedBox(
              width: 368.0,
              height: 210.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    pinBottom: true,
                    child:
                        // Adobe XD layer: 'blue-programming-co…' (shape)
                        Container(
                      decoration: BoxDecoration(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'box4_codingevn' (group)
                SizedBox(
              width: 368.0,
              height: 210.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    pinBottom: true,
                    child:
                        // Adobe XD layer: 'DG9DuM9UQAIbSrS' (shape)
                        Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(25.0),
                        image: DecorationImage(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'box1_codingevn' (group)
                SizedBox(
              width: 368.0,
              height: 210.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    pinBottom: true,
                    child:
                        // Adobe XD layer: 'coding-bootcamp-mot…' (shape)
                        Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(25.0),
                        image: DecorationImage(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'box2_codingevn' (group)
                SizedBox(
              width: 368.0,
              height: 210.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    pinBottom: true,
                    child:
                        // Adobe XD layer: '2017-11-22-PHOTO-00…' (shape)
                        Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(25.0),
                        image: DecorationImage(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'backarrow_codingevn' (group)
                PageLink(
              links: [
                PageLinkInfo(
